...
public class CreateAccountCommandValidatorTests : TestBase
{
    ...
    {
        // Arrange
        var command = Fixture.Build<CreateAccountCommand>().With(x => x.Name, name).Create();
    ...
    {
        // Arrange
        var command = Fixture.Build<CreateAccountCommand>().With(x => x.RiskBalance, riskBalance).Create();
    ...
    {
        // Arrange
        var command = Fixture.Build<CreateAccountCommand>().With(x => x.Split, split).Create();
    ...
    {
        // Arrange
        var command = Fixture.Build<CreateAccountCommand>().With(x => x.Description, description).Create();
